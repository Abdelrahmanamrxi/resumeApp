  ...
  return (
    <>
      ...
      <div className="relative isolate px-6 py-24 sm:py-16 lg:px-8">
        ...
        <motion.p
          className="mx-auto mt-6 max-w-2xl text-center text-lg font-medium text-gray-600 sm:text-xl"
          initial={{ opacity: 0 }}
        ...
        {/* Pricing grid */}
        <motion.div
          className="mx-auto mt-16 grid max-w-lg grid-cols-1 items-center gap-y-6 sm:mt-20 lg:max-w-4xl lg:grid-cols-2"
          initial="hidden"
          whileInView="visible"
          variants={{
        ...
        >
          ...
          <motion.div
            ...
            className="rounded-3xl bg-white/60 p-8 ring-1 ring-gray-900/10 flex flex-col sm:mx-8 sm:rounded-b-none sm:p-10 lg:mx-0 lg:rounded-tr-none lg:rounded-bl-3xl"
          >
            ...
            <Button className="text-center mt-8 cursor-pointer sm:mt-10 ring-1 ring-inset ring-indigo-50 py-5" variant={"outline"}>
              Get Started Today
            </Button>
          </motion.div>
          ...
          <motion.div
            variants={{ hidden: { opacity: 0, y: 30 }, visible: { opacity: 1, y: 0 } }}
            className="relative rounded-3xl flex flex-col bg-black p-8 shadow-2xl ring-1 ring-gray-900/10 sm:p-10"
          >
